...
TEST(ValueTest, BasicFloatOperations) {
	...
	b.zero_grad();
	(a / b).backward();
    EXPECT_NEAR(a.gradX(), 1.0f / 3.0f, 0.001);
...
TEST(ValueTest, BasicFloatDoubleOperations) {
    ...
    (a / b).backward();
    EXPECT_NEAR(a.gradX(), 1.0f / 3.0f, 0.001);
    EXPECT_NEAR(b.gradX(), -2.0f / 9.0f, 0.001);
...
TEST(ValueTest, BasicDoubleFloatOperations) {
    ...
    b.zero_grad();
    (a / b).backward();
    EXPECT_NEAR(a.gradX(), 1.0 / 3.0, 0.001);
    EXPECT_NEAR(b.gradX(), -2.0 / 9.0f, 0.001);
